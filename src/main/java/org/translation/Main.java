...
public class Main {
    ...
    private static String promptForCountry(Translator translator) {
        ...
        List<String> countries = countryCodes.stream().map(COUNTRY_CODE_CONVERTER::fromCountryCode).sorted().toList();
    ...
    private static String promptForLanguage(Translator translator, String country) {
        ...
        List<String> countries = languageCodes.stream().map(LANGUAGE_CODE_CONVERTER::fromLanguageCode)
                .sorted().toList();
        for (String c : countries) {
            System.out.println(c);
        }
